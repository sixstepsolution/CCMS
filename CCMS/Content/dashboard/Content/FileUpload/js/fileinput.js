...
(function (factory) {
    ...
    defaultPreviewSettings = {
        ...
        html: { width: "60px", height: "60px" },
        text: { width: "60px", height: "60px" },
        video: { width: "60px", height: "60px" },
        audio: { width: "60px", height: "60px" },
        flash: { width: "60px", height: "60px" },
        object: { width: "60px", height: "60px" },
        pdf: { width: "100px", height: "60px" },
        other: { width: "60px", height: "60px" }
    };
    ...
    FileInput.prototype = {
        ...
        _renderFileFooter: function (caption, size, width, isError) {
            ...
            if (self.isUploadable) {
                ...
                out = template.replace(/\{actions}/g,
                    self._renderFileActions(upl, rem, zoom, drg, false, false, false))
                    .replace(/\{caption}/g, caption).replace(/\{size}/g, size).replace(/\{width}/g, width)
        ...
        _change: function (e) {
            ...
            if (isDragDrop) {
                ...
                if ($("#DocumentsType").val() != "") {
                    $("#DocumentsType").removeClass('error');
                    ...
                    $("#DocumentsType").addClass('error');
                    $("#uploadDocError").html('Please Select Document Type!');
                }
            }
    ...
    $.fn.fileinputLocales.en = {
        ...
        //dropZoneTitle: 'Drag & drop files here &hellip;',   // commented by mahesh
        dropZoneTitle: 'Preview Files &hellip;',   // commented by ma
