        ...
        $(function () {
            ...
            var calendar = new Calendar(calendarEl, {
                ...
                events: [
                    ...
                    {
                        title: 'AURUM SEBOKENG',
                        start: new Date(y, m, d + 15, 19, 0),
                        end: new Date(y, m, d + 15, 22, 30),
                        allDay: true,
                        backgroundColor: '#00a65a', //Success (green)
                        borderColor: '#00a65a' //Success (green)
                    }
                    ,
                    {
                        title: 'HOME LODGEMENT',
                        start: new Date(y, m, d + 20, 19, 0),
                        end: new Date(y, m, d + 20, 22, 30),
                        allDay: true,
                        backgroundColor: '#00a65a', //Success (green)
                        borderColor: '#00a65a' //Success (green)
                    }
